...
Generated by 'djangoadmin startproject' using Django 2.1.5.
...
SECRET_KEY = 'hteh7o45=+x#3@2_j7)kybs88d@z5!kiceezpls9l+7+5zjy$e'
...
# Password validation
# https://docs.djangoproject.com/en/2.1/ref/settings/#authpasswordvalidators
...
# https://docs.djangoproject.com/en/2.1/howto/staticfiles/
